...
import {IonPage,IonContent, IonList,IonCol,IonRow,IonIcon,IonLabel,IonItem,IonCard,IonButton,IonCardContent,IonGrid} from "@ionic/react";
...
<IonPage>
    ...
    { user ? (
        ...
        <IonRow>
            <IonCol>
                <IonButton expand="block" routerLink={`/editprofile`} color="primary" fill="outline">
                    Edit profile
                </IonButton>
            </IonCol>
        </IonRow>
