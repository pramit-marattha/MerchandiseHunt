...
const Forgot = (props) => {
    ...
    async function handleResetPassword(){
        ...
        try {
            ...
            console.error("Error while reseting password.. Please try again later!",err)
            toast(err.message)
        }
    ...
    return (
        <IonPage>
            ...
            <IonContent>
                ...
                <IonRow>
                    <IonCol>
                        <IonButton type="submit" color="primary" expand="block" onClick={handleSubmit} disabled={loading}>Email my password</IonButton>
                    </IonCol>
                </IonRow>
